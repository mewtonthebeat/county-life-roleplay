...
Dealership::CreateTextdraws(playerid)
{
	...
	dealershipTD[playerid][2] = CreatePlayerTextDraw(playerid, 169.999908, 126.853378, "_"); //názov
	...
	dealershipTD[playerid][7] = CreatePlayerTextDraw(playerid, 381.428405, 155.440032, "_"); //názov auta
